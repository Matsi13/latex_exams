...
（5）\ding{172}$\frac{\pi}{2a}$\ding{173}$\sqrt{15}:1$\\
（6）\ding{172}$24N_A$\ding{173}$16N_A$\ding{174}$8N_A$\\
（7）\ding{172}$-\frac{A}{r^6}$\ding{173}$\frac{B}{r^{12}}$\ding{174}$\sqrt[6]{\frac{2B}{A}}$\ding{175}$-\frac{NA^2}{4B}$\\
（8）\ding{172}$1.38\times10^{23}J$\ding{173}$4.88\degree$\\
