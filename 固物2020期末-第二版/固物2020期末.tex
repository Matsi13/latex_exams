...
（2）\ding{172}原胞\ding{173}单胞\\
（4）\ding{172}硅和锗\\
（5）\ding{172}马德隆常数\ding{173}晶体结构\\
（6）\ding{172}抛物线型\ding{173}斜率的变化率\\
（7）\ding{172}$\frac{(n-1)q^2}{a^3}$\ding{173}$\frac{(n-1)q^2}{a^3}$\\
（8）\ding{172}扩散\ding{173}漂移\ding{174}界面\ding{175}反比\ding{176}少子\\
（9）\ding{172}$\frac{S}{4\pi^2}$\ding{173}$\frac{Sm}{\pi\hbar^2}$\\
（10）\ding{172}<\ding{173}半导体\\
...
（17）\ding{172}面心立方\ding{173}$\frac{16\pi^3}{a^3}$\ding{174}$\frac{\hbar^2}{2ma^2}(6\pi^2)^{\frac{2}{3}}$\\
（18）\ding{172}抗磁性\ding{173}顺磁性\ding{174}铁磁性\ding{175}亚铁磁性\ding{176}反铁磁性\ding{177}轨道磁矩\ding{178}自旋磁矩\ding{179}感生磁矩\\
\section*{2.}
（1）面心立方
\begin{equation*}
    \begin{aligned}
